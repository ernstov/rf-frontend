    ...
    <div class="px-60 py-32">
      ...
      <div class="flex flex-wrap">
        <base-card v-for="program in programs" :key="program.id" class="card">
          ...
          <div class="absolute right-3 top-3 hidden edit items-center">
            <div @click="programToEdit = program" class="mr-3">
              <svg
            ...
            <div @click="programToDelete = program">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-12 w-12 p-2 text-red-400"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                stroke-width="2"
